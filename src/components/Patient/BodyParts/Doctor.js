    ...
    return (
        <div className='w-full bg-[#5cdb95] grid grid-cols-3 mt-2 border-[1px] border-black'>
            <div className='flex flex-col items-center py-4'>
                ...
                <h1 className='text-xl font-bold'>Prof. Dr. M.N. Huda</h1>
            </div>
            <div className='flex flex-col py-4'>
                <h1><span className='font-bold text-red-600'>Education:</span> MBBS (DMC), DDV (DU), FCPS (Skin & Sex)</h1>
                <h1><span className='font-bold text-red-600'>Speciality:</span> Expert Dermatologist, Sexologist & Venereologist</h1>
                <h1><span className='font-bold text-red-600'>Current Posting:</span> Dhaka Medical College & Hospital</h1>
            </div>
            ...
            {appointment && <Appointment modalState={appointment} setModalState={setAppointment} />}
        </div>
    )
}

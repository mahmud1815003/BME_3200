        ...
        <div className='max-w-full w-full h-[80px] bg-[#5cdb95] sm:px-6 px-4 flex flex-row justify-between items-center text-[#05386b] font-["Noto_Sans"]'>
            ...
            <div className='lg:block hidden'>
                <ul className='flex flex-row text-lg font-bold cursor-pointer items-center'>
                    ...
                    <Link to={'/login'}><li className='ml-6 text-white bg-[#05386b] px-3 py-3 rounded-md'>Log In</li></Link>
                    <Link to={'/signup'}><li className='ml-6 text-white bg-[#05386b] px-3 py-3 rounded-md'>Sign Up</li></Link>
                </ul>
            </div>
            ...
            </div>
            {
                ham && <div className='absolute top-[80px] left-0 w-full p-6 bg-[#5cdb95] lg:hidden block z-50'>
                    <ul className='flex flex-col text-lg font-bold cursor-pointer w-full items-center'>
                        ...
                        <Link to={'/login'}><li className='ml-6 mt-4 text-white bg-[#05386b] px-3 py-3 rounded-md'>Log In</li></Link>
                        <Link to={'/login'}><li className='ml-6 mt-4 text-white bg-[#05386b] px-3 py-3 rounded-md'>Sign Up</li></Link>
                    </ul>
                </div>
            }
        </div>

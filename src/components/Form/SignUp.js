  ...
  return (
    <div className='w-full h-full mx-auto'>
            ...
            <div className='my-2 flex flex-col'>
                ...
                <p className='text-[#DC143C] text-sm'>Error Goes Here</p>
            </div>
            <div className='my-2 flex flex-col'>
            ...
            <div className='my-2 flex flex-col'>
                <label className="text-lg font-bold py-1">Select Your Account Type</label>
            ...
            <h1 className='text-[#DC143C]'>*Give Institutional Mail For Researcher</h1>
        </form>
